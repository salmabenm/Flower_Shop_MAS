      ...
      <div class="box">
         <div class="image">
            <img class="image" src="images/<?php echo $fetch_products['image']; ?>" alt="">
               <div class="icons">
                  <a href="admin_update_product.php?update=<?php echo $fetch_products['id']; ?>" class="cart-btn">Update</a>
                  <a href="admin_products.php?delete=<?php echo $fetch_products['id']; ?>" class="cart-btn" onclick="return confirm('delete this product?');">Delete</a>
               </div>
         </div>
