...
<h1 class="heading"> Your<span> cart </span></h1>
  <table>
    ...
    ?>
        ...
        <td><input type="submit" value="UPDATE" class="btn" name="update_quantity"></td></form>
			</tr>
  ...
  <div class="cart__actions">
    ...
    <a class="cart__button cart__button--checkout" href="checkout.php" <?php echo ($grand_total > 1) ? '' : 'disabled' ?>>
      <span>Checkout</span>
    </a>
